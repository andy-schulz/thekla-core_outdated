...
describe('When using the BrowserWdjs class', () => {
    ...
    describe('to delete a single browser', () => {
        ...
        it('the browser map should be empty when the browser is deleted ' +
            ...
            const browser = BrowserWdjs.create(conf);
    ...
    describe('to delete multiple browser', () => {
        ...
        beforeEach(() => {
            browser1 = BrowserWdjs.create(conf, "browser_1");
            browser2 = BrowserWdjs.create(conf, "browser_2");
            browser3 = BrowserWdjs.create(conf, "browser_3");
            browser4 = BrowserWdjs.create(conf, "browser_4");
        });
