...
describe('When using the BrowserWdjs class', () => {
    ...
    describe('to startedOn a single browser', () => {
        it('with an empty browser name, it should throw an invalid browser name error ' +
            '- (test case id: f25ffac2-c583-458b-9ee1-db22a6ef0423)', () => {
            try {
        ...
        it('with invalid browser name characters, it should throw an invalid character error ' +
            '- (test case id: cbbc5a1b-efe9-4152-800e-dab0a1ba5d8b)', () => {
        ...
        it('without a name,it should be created with a default name ' +
            ...
            const browser: Browser = BrowserWdjs.create(conf, capabilities);
    ...
    describe('to startedOn multiple browser', () => {
        it('without a name, they should be created with a default name ' +
            ...
            const browser1: Browser = BrowserWdjs.create(conf, capabilities);
            const browser2: Browser = BrowserWdjs.create(conf, capabilities);
        ...
        it('and only the first browser gets a name, the second browser should get a default name ' +
            ...
            const browser1: Browser = BrowserWdjs.create(conf, capabilities, "theFirstBrowser");
            const browser2: Browser = BrowserWdjs.create(conf, capabilities);
        ...
        it('and only the second browser gets a name, the first browser should get a default name ' +
            '- (test case id: 83b28cf5-7fba-4597-b5ec-64495caa5053)', () => {
            const browser1: Browser = BrowserWdjs.create(conf, capabilities);
            const browser2: Browser = BrowserWdjs.create(conf, capabilities, "theSecondBrowser");
    ...
    describe('to delete a single browser', () => {
        ...
        it('the browser map should be empty when the browser is deleted ' +
            ...
            const browser = BrowserWdjs.create(conf, capabilities);
    ...
    describe('to delete multiple browser', () => {
        ...
        beforeEach(async () => {
            browser1 = BrowserWdjs.create(conf, capabilities, "browser_1");
            browser2 = BrowserWdjs.create(conf, capabilities, "browser_2");
            browser3 = BrowserWdjs.create(conf, capabilities, "browser_3");
            browser4 = BrowserWdjs.create(conf, capabilities, "browser_4");
        });
